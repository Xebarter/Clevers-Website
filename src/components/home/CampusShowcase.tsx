        ...
        {campuses.map((campus) => (
          <TabsTrigger
            ...
            className={cn("py-3 px-4", {
              "border-b-2 border-red-500": campus.id === activeTab && campus.color === "school-red",
              "border-b-2 border-blue-500": campus.id === activeTab && campus.color === "school-blue",
              "border-b-2 border-green-500": campus.id === activeTab && campus.color === "school-green",
            })}
          >
            <div className="text-center">
              <div className={cn("w-4 h-4 rounded-full mx-auto mb-2", {
                "bg-red-500": campus.color === "school-red",
                "bg-blue-500": campus.color === "school-blue",
                "bg-green-500": campus.color === "school-green",
              })} />
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start">
                    <MapPin className={cn("h-5 w-5 mr-3 flex-shrink-0 mt-0.5", {
                      "text-red-500": campus.color === "school-red",
                      "text-blue-500": campus.color === "school-blue",
                      "text-green-500": campus.color === "school-green",
                    })} />
                    <span>{campus.address}</span>
                  </div>
                  <div className="flex items-start">
                    <Phone className={cn("h-5 w-5 mr-3 flex-shrink-0 mt-0.5", {
                      "text-red-500": campus.color === "school-red",
                      "text-blue-500": campus.color === "school-blue",
                      "text-green-500": campus.color === "school-green",
                    })} />
