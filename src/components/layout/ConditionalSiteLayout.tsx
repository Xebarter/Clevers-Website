    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        <a
          ...
          className="flex items-center justify-center rounded-full bg-pink-500 p-3 text-white shadow-lg transition-all hover:scale-105 hover:bg-pink-600"
          aria-label="Call us"
        >
        ...
        <a
          ...
          className="flex items-center justify-center rounded-full bg-[#25D366] p-3 text-white shadow-lg transition-all hover:scale-105 hover:bg-[#20ba5a]"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center rounded-full bg-black p-3 text-white shadow-lg transition-all hover:scale-105 hover:bg-zinc-800"
