...
export const metadata: Metadata = {
  ...
  description: "Explore our kindergarten sports program designed to develop motor skills, teamwork, and a lifelong love of physical activity through fun, age-appropriate activities.",
};
...
const sportsActivities = [
  {
    name: "Mini Athletics",
    description: "Age-appropriate running, jumping, and throwing activities that develop fundamental movement skills in a fun, non-competitive environment.",
  ...
  {
    name: "Team Games",
    description: "Simplified versions of football, netball, and other team sports that emphasize cooperation, taking turns, and understanding basic rules.",
  ...
  },
  {
    ...
    description: "Fun activities using balance beams, hoops, and obstacle courses to develop coordination, stability, and body control.",
  ...
  },
  {
    ...
    description: "Introduction to water safety and beginner swimming skills in our partner facility's shallow pool, supervised by trained instructors.",
  ...
  {
    name: "Yoga for Kids",
    description: "Child-friendly yoga poses, breathing exercises, and relaxation techniques that improve flexibility and body awareness.",
  ...
  {
    name: "Dance & Movement",
    description: "Creative movement activities set to music that encourage self-expression, rhythm, and cultural appreciation.",
...
const sportsEvents = [
  {
    ...
    date: "February",
    description: "A fun-filled day of age-appropriate races and games where every child participates and is celebrated.",
    icon: <Trophy className="h-5 w-5 text-kinder-yellow" />
  },
  {
    name: "Parent-Child Sports Day",
    date: "May",
    description: "A special event where parents join their children for team games and activities, strengthening family bonds.",
    icon: <Users className="h-5 w-5 text-kinder-green" />
  },
  {
    name: "Swimming Showcase",
    date: "August",
    description: "Children demonstrate their water confidence and basic swimming skills learned throughout the term.",
    icon: <Shield className="h-5 w-5 text-kinder-blue" />
  },
  {
    name: "Dance Performance",
    date: "November",
    description: "A celebration of movement and rhythm as children perform choreographed dances from various cultures.",
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <h2 className="text-3xl font-bold mb-6 font-heading text-kinder-green">Our Philosophy</h2>
              ...
              <div className="space-y-4 mt-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-kinder-green font-heading">Joy in Movement</h3>
                    <p className="text-gray-700 font-body">We create positive experiences that help children develop a lifelong love of physical activity.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-kinder-green font-heading">Inclusive Participation</h3>
                    <p className="text-gray-700 font-body">Every child participates regardless of ability level, with activities adapted to ensure success for all.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-bold text-kinder-green font-heading">Developmental Appropriateness</h3>
                    <p className="text-gray-700 font-body">Our activities are designed specifically for early childhood, focusing on fundamental skills rather than competition.</p>
                  </div>
                </div>
              </div>
            </div>

            <div className="order-1 md:order-2 bg-kinder-yellow/10 p-6 rounded-3xl border-2 border-kinder-yellow/30 shadow-md">
              <div className="aspect-video relative rounded-2xl overflow-hidden border-4 border-white shadow-md">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-gray-100">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 font-heading">Children enjoying sports activities</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {sportsActivities.map((activity, index) => (
              <Card key={index} className="border-2 border-gray-200 rounded-3xl overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                <div className={`bg-${activity.color}/10 p-6`}>
                  <div className="flex gap-4 items-start">
                    <div className={`w-12 h-12 rounded-full bg-${activity.color}/20 flex-shrink-0 flex items-center justify-center`}>
                      {activity.icon}
                    </div>
                    <div>
                      <h3 className={`text-xl font-bold mb-2 font-heading text-${activity.color}`}>{activity.name}</h3>
                ...
                <CardContent className="p-4">
                  <h4 className="text-sm font-semibold mb-2 font-heading text-gray-700">Key Benefits:</h4>
                  <div className="flex flex-wrap gap-2">
                    {activity.benefits.map((benefit, i) => (
                      <span key={i} className={`text-xs py-1 px-2 rounded-full bg-${activity.color}/10 text-${activity.color} font-body`}>
                        {benefit}
                      </span>
                    ))}
                  </div>
                    ...
                    <div key={index} className="flex gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          <span className="font-semibold text-gray-700 font-heading">{event.name}</span>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-3xl shadow-md border-2 border-kinder-green/20 text-center">
              ...
              <h3 className="text-lg font-bold mb-2 font-heading text-kinder-green">Outdoor Play Areas</h3>
            ...
            <div className="bg-white p-6 rounded-3xl shadow-md border-2 border-kinder-blue/20 text-center">
              ...
              <h3 className="text-lg font-bold mb-2 font-heading text-kinder-blue">Swimming Partnership</h3>
              <p className="text-gray-700 font-body">
            ...
            <div className="bg-white p-6 rounded-3xl shadow-md border-2 border-kinder-red/20 text-center">
              ...
              <h3 className="text-lg font-bold mb-2 font-heading text-kinder-red">Movement Studio</h3>
              <p className="text-gray-700 font-body">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-3xl shadow-md border-2 border-kinder-purple/20">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-gray-800 font-heading">Mrs. Nakato</div>
                  <div className="text-sm text-gray-600 font-body">Parent of Sarah, Age 5</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-3xl shadow-md border-2 border-kinder-yellow/20">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-gray-800 font-heading">Mr. Okello</div>
                  <div className="text-sm text-gray-600 font-body">Parent of David, Age 4</div>
                </div>
              </div>
            </div>
          </div>
