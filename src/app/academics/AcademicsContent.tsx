            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
              <div>
                ...
                <div className="relative">
                  <input
                    type="text"
                    id="studentName"
                    className="w-full p-2.5 sm:p-3 pl-9 sm:pl-10 border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-sm sm:text-base"
                    placeholder="Student's full name"
                    value={formData.studentName}
                    onChange={handleChange}
                    required
                  />
                  <User className="h-4 w-4 sm:h-5 sm:w-5 text-blue-500 absolute left-3 top-3 sm:top-3.5" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                  />
                  <Calendar className="h-4 w-4 sm:h-5 sm:w-5 text-blue-500 absolute left-3 top-3 sm:top-3.5" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  <select
                    id="gender"
                    className="w-full p-2.5 sm:p-3 pl-9 sm:pl-10 border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-sm sm:text-base appearance-none"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <BookOpen className="h-4 w-4 sm:h-5 sm:w-5 text-blue-500 absolute left-3 top-3 sm:top-3.5" />
                </div>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    type="text"
                    id="parentName"
                    className="w-full p-2.5 sm:p-3 pl-9 sm:pl-10 border border-purple-200 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-white text-sm sm:text-base"
                    placeholder="Parent/guardian's full name"
                    value={formData.parentName}
                    onChange={handleChange}
                    required
                  />
                  <User className="h-4 w-4 sm:h-5 sm:w-5 text-purple-500 absolute left-3 top-3 sm:top-3.5" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  <select
                    id="relationship"
                    className="w-full p-2.5 sm:p-3 pl-9 sm:pl-10 border border-purple-200 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-white text-sm sm:text-base appearance-none"
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                  />
                  <Phone className="h-4 w-4 sm:h-5 sm:w-5 text-purple-500 absolute left-3 top-3 sm:top-3.5" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                  />
                  <Mail className="h-4 w-4 sm:h-5 sm:w-5 text-purple-500 absolute left-3 top-3 sm:top-3.5" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
              <div>
                ...
                <div className="relative">
                  <select
                    id="campus"
                    className="w-full p-2.5 sm:p-3 pl-9 sm:pl-10 border border-green-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white text-sm sm:text-base appearance-none"
                  ...
                  <School className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 absolute left-3 top-3 sm:top-3.5" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  ...
                  <Home className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 absolute left-3 top-3 sm:top-3.5" />
                </div>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    type="text"
                    id="previousSchool"
                    className="w-full p-2.5 sm:p-3 pl-9 sm:pl-10 border border-amber-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-white text-sm sm:text-base"
                    placeholder="Previous school's name"
                    value={formData.previousSchool}
                    onChange={handleChange}
                  />
                  <School className="h-4 w-4 sm:h-5 sm:w-5 text-amber-500 absolute left-3 top-3 sm:top-3.5" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  <textarea
                    ...
                    onChange={handleChange}
                  />
                  <BookOpen className="h-4 w-4 sm:h-5 sm:w-5 text-amber-500 absolute left-3 top-3 sm:top-3.5" />
                </div>
              </div>
              <div>
                ...
                <div className="relative">
                  <select
                    id="howHeard"
                    className="w-full p-2.5 sm:p-3 pl-9 sm:pl-10 border border-amber-200 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-white text-sm sm:text-base appearance-none"
